class Plant:
    """Base class representing common features of all garden plants."""
...
class Flower(Plant):
    """A specialized plant type that can bloom and has a color."""
...
class Tree(Plant):
    """A specialized plant type that grows tall and provides shade."""
...
class Vegetable(Plant):
    """A specialized plant type grown for harvest and nutrition."""
    def __init__(self, name: str, height: int, age: int,
