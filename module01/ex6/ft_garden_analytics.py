class Plant:
    """Base class for plants, tracking growth from their initial height."""
...
class FloweringPlant(Plant):
    """A plant that blooms with a specific color."""
...
class PrizeFlower(FloweringPlant):
    """A highly valued flowering plant that awards prize points."""
...
class GardenManager:
    """Manages a network of gardens and their respective plants."""
    total_gardens = 0

    class GardenStats:
        """Helper class to calculate statistics and analytics for a garden."""
